...
require_once("config.php");
$cid=$_GET['cid'];
$today=mysqli_query($conn,"select order_id,order_no,w.phone,l.address1,ord_date,ord_time,status,w.name  from order_table  o join cusomer c on o.cust_id=c.cost_id join worker_reg w on w.worker_id=o.worker_id join worker_location l on w.worker_id=l.worker_id where cust_id='$cid' and status='accepted'");
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Your Completed Orders</p>
	<br><br><br>
