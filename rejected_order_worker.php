...
require_once("config.php");
$wid=$_GET['wid'];
$today=mysqli_query($conn,"select order_id,order_no,phone,address1,ord_date,ord_time,status,name  from order_table  o join cusomer c on o.cust_id=c.cost_id where worker_id='$wid' and status='rejected'");
