...
$cust_id=$_GET['cid'];
$sql="select * from cusomer where cost_id='$cust_id'";
...
$pic=str_replace("C:fakepath", "uploaded_images/", $cust_pic);
...
<div class="card">
  ...
  <p class="title"><i class="fa fa-envelope" aria-hidden="true"></i> :   <?php echo $cust_email; ?></p>
  <p class="title"><i class="fa fa-phone" aria-hidden="true"></i>   :     <?php echo $cust_phone; ?></p>
